...
using var credentials = new Credentials(publicKey, privateKey);
...
await signer.SignRequestAsync(requestMessage, credentials);
await signer.ValidateSignatureAsync(requestMessage, credentials.PrivateKey, requestTimeWindow);
